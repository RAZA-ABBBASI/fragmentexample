...
public class ModalBottomSheetFragment extends BottomSheetDialogFragment {
    ...
    public static ModalBottomSheetFragment newInstance(int itemCount) {
        final ModalBottomSheetFragment fragment = new ModalBottomSheetFragment();
    ...
    private class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(LayoutInflater inflater, ViewGroup parent) {
            ...
            super(inflater.inflate(R.layout.fragment_modal_bottom_sheet_list_dialog_item, parent, false));
